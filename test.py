...
from utils import decode, compute_nms
from data_loader import create_batch_generator
...
parser.add_argument('--data-dir', default='./test_plate-PascalVOC-export/')
...
parser.add_argument('--checkpoint-path', default='/Users/henry/Downloads/checkpoint/ssd_epoch_120.h5')
