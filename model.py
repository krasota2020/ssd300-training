...
from layers import create_vgg16_layers, create_ssd_layers, create_conf_head_layers, create_loc_head_layers
...
class SSD(Model):
    ...
    def __init__(self, num_classes):
        ...
        self.extra_layers = create_ssd_layers()
    ...
    def compute_heads(self, x, idx):
        """ Return outputs of classificasion and regression model heads
        Args:
            x: the input feature map
            idx: index of the head layer
        Returns:
            conf: output of the classification head
            loc: output of the regression head
        """
...
def create_ssd(num_classes, pretrained_type,
    ...
    Args:
        num_classes: number of classes
        pretrained_type: type of pretrained weights ('VGG16' or 'ssd')
